...
import { DollarSign, TrendingUp, Users, ShieldAlert, Briefcase, PlusCircle, Activity, Anchor, BarChart } from 'lucide-react';
...
export const CompanyModal: React.FC<CompanyModalProps> = ({ 
  company, products, resources, marketWage, onClose, onUpdate, onDividend, onAddLine 
}) => {
