...
import { Crown, Vote, Search, Landmark, ArrowUp, ArrowDown, Wallet, Wheat, Factory, Briefcase, TrendingUp, Activity, PieChart } from 'lucide-react';
...
export const CityHallTab: React.FC<CityHallTabProps> = ({ gameState, companies }) => {
  ...
  const { election, mayorId, population, cityTreasury, economicOverview } = gameState;
