        ...
        <div className="bg-gradient-to-r from-indigo-900 to-stone-900 p-6 rounded-xl border border-indigo-700/50 relative overflow-hidden">
            <div className="relative z-10">
                ...
                <p className="text-indigo-200 mt-2 max-w-2xl">
                    验证模拟是否符合现实世界的“典型事实 (Stylized Facts)”。一个真实的经济体应该表现出特定的统计特性（例如：失业率与通货膨胀之间的负相关关系）。
                </p>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card title="1. 菲利普斯曲线 (Phillips Curve)" className="bg-stone-900 border-stone-800">
                <div className="p-2 flex justify-between items-center bg-stone-950/50 mb-4 rounded border border-stone-800">
                     <div className="text-sm text-stone-400">失业率与通胀率的相关性。预期应为负相关 (&lt; 0)。当前相关系数: {phillips.score}</div>
            ...
            <Card title="2. 消费平滑 (Consumption Smoothing)" className="bg-stone-900 border-stone-800">
                <div className="p-2 flex justify-between items-center bg-stone-950/50 mb-4 rounded border border-stone-800">
            ...
            <Card title="3. 企业规模分布 (Zipf's Law)" className="bg-stone-900 border-stone-800">
                 <div className="p-2 flex justify-between items-center bg-stone-950/50 mb-4 rounded border border-stone-800">
            ...
            {/* Fact 4: Wealth & MPC */}
            <Card title="4. 边际消费倾向 (MPC by Wealth)" className="bg-stone-900 border-stone-800">
                 <div className="p-2 flex justify-between items-center bg-stone-950/50 mb-4 rounded border border-stone-800">
