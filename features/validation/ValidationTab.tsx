...
import { CheckCircle2, XCircle, Beaker, Zap, Activity } from 'lucide-react';
import { useGameStore } from '../../shared/store/useGameStore';

export const ValidationTab: React.FC = () => {
  const [activeMode, setActiveMode] = useState<'validate' | 'experiment'>('validate');
  ...
  return (
    <div className="space-y-6 animate-in fade-in pb-10">
        <div className="flex gap-4 mb-4">
            ...
            >
                <Beaker size={18}/> 理论验证 (Calibration)
            </button>
            <button 
